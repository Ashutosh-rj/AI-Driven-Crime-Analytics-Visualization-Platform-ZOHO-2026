...
Revision ID: 2220ed3d55f3
Revises: 
Create Date: 2026-07-19 07:00:02.455968
...
def upgrade() -> None:
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('crime_no', sa.String(), nullable=True),
    ...
    sa.Column('brief_facts', sa.String(), nullable=True),
    ...
    op.create_index('idx_CaseMaster_location', 'CaseMaster', ['location'], unique=False, postgresql_using='gist')
    op.create_index(op.f('ix_CaseMaster_crime_no'), 'CaseMaster', ['crime_no'], unique=True)
    op.create_index(op.f('ix_CaseMaster_id'), 'CaseMaster', ['id'], unique=False)
    op.create_table('EventsLedger',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_index(op.f('ix_EventsLedger_id'), 'EventsLedger', ['id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_EventsLedger_id'), table_name='EventsLedger')
    op.drop_table('EventsLedger')
    op.drop_index(op.f('ix_CaseMaster_id'), table_name='CaseMaster')
    op.drop_index(op.f('ix_CaseMaster_crime_no'), table_name='CaseMaster')
    op.drop_index('idx_CaseMaster_location', table_name='CaseMaster', postgresql_using='gist')
